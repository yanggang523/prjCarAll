...
; 0000 0085 {
; 0000 0086 //테스트 목적
; 0000 0087 delay_ms(5000);       // 5초 동안 대기
	LDI  R26,LOW(5000)
	LDI  R27,HIGH(5000)
	RCALL _delay_ms
; 0000 0088 Go_Straight();  // 직진
	RCALL _Go_Straight
; 0000 0089 delay_ms(2000); // 2초 동안 직진
	RCALL SUBOPT_0x2
; 0000 008A Stop();
; 0000 008B delay_ms(500);  // 0.5초 동안 정지
; 0000 008C 
; 0000 008D Turn_Right();   // 우회전
	RCALL _Turn_Right
; 0000 008E delay_ms(2000); // 2초 동안 우회전
	RCALL SUBOPT_0x2
; 0000 008F Stop();
; 0000 0090 delay_ms(500);
; 0000 0091 
; 0000 0092 Turn_Left();    // 좌회전
	RCALL _Turn_Left
; 0000 0093 delay_ms(2000); // 2초 동안 좌회전
	RCALL SUBOPT_0x2
; 0000 0094 Stop();
...
; 0000 0097 Back();         // 후진
	RCALL _Back
; 0000 0098 delay_ms(2000); // 2초 동안 후진
	RCALL SUBOPT_0x2
; 0000 0099 Stop();
; 0000 009A delay_ms(500);
; 0000 009B 
; 0000 009C 
; 0000 009D if (UCSR0A & (1 << RXC0)) {
	SBIS 0xB,7
	RJMP _0x2E
; 0000 009E ch = UDR0;
	IN   R5,12
...
; 0000 00A0 if (ch == '8') {
	...
	CP   R30,R5
	BRNE _0x2F
; 0000 00A1 Go_Straight();
	RCALL _Go_Straight
; 0000 00A2 } else if (ch == '2') {
	RJMP _0x30
_0x2F:
	LDI  R30,LOW(50)
	CP   R30,R5
...
; 0000 00A5 Turn_Left();
	RCALL _Turn_Left
; 0000 00A6 } else if (ch == '6') {
	RJMP _0x34
_0x33:
	LDI  R30,LOW(54)
	CP   R30,R5
	BRNE _0x35
; 0000 00A7 Turn_Right();
	RCALL _Turn_Right
; 0000 00A8 } else if (ch == '5') {
	RJMP _0x36
_0x35:
	LDI  R30,LOW(53)
	CP   R30,R5
